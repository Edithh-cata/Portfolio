!function(o, l) {
                    ...
                    for (var t, n, i, o = e.attributes, a = 0; a < o[b]; a++)
                        if (n = (t = o[a]).name, -1 == v.indexOf(n))
                            if (i = t.value, n == d) {
                                ...
                                u && u.localName.toLowerCase() == d ? f = u : (f = l[s]("http://www.w3.org/2000/svg", d), r.insertBefore(f, u)),
                                f.textContent = i
                            } else
                                r[k](n, i)
                }(e, r);
    ...
    var e = function z(e, r) {
        ...
        }('img[onload^="' + e + '("]{visibility:hidden;}'), h.setOptions = function(e) {
            t = p(t, e)
        }, h.create = z, h.err = function(e, r) {
